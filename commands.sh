...
spotify-ripper music/playlists/"TheBaddest"
...
docker run --rm -it -v $(pwd)/"music/playlists":/music ritiek/spotify-downloader -p https://open.spotify.com/playlist/7CkCllQ3Zklt8yBW7oPYSC
