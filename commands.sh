...
spotify-ripper music/playlists/"unleashed"
...
docker run --rm -it -v $(pwd)/"music/playlists":/music ritiek/spotify-downloader -p https://open.spotify.com/playlist/3lvow4CJMct5ApgxcqhHae
